...
```
#### 注释：
本课件非常经典！只是鉴于Jiang老师提供的原始课件用英文写成，而我作为Python的爱好者计算机英文又不太好，讲义看起来比较慢，为了提高自学课件的效率，故我花了点时间将其翻译成中文版，以便将来自己快速复习用该版用于个人学习使用，绝不作商业用途。现将其分享出来。翻译水平有限，若有不当之处，还请大家指正。谢谢！
```
